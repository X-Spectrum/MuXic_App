...
class FolderListPage extends StatefulWidget {
  FolderListPage({Key? key, required this.setHomeState, required this.player}) : super(key: key);
            ...
            Expanded(
              child: Container(
                  ...
                  child: FutureBuilder<List<String>>(
                    future: audioQuery.queryAllPath(),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) => Container(
                            ...
                            child: ListTile(
                              ...
                              title: Text(item.data![index].split("/").last, overflow: TextOverflow.ellipsis ,style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w500)),
                              subtitle: Text(item.data![index], overflow: TextOverflow.ellipsis ,style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w300)),
                              contentPadding: EdgeInsets.symmetric(horizontal: 5.0),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(15.0),
                              ),
                              onTap: () => widget.setHomeState(4, 5, item.data![index]),
                            ),
                          ),
                        );
                      }
